...
public class ServerIdGroupValidatorHandler extends IdValidationHandler {
    public ServerIdGroupValidatorHandler(Runnable failureTask, Runnable successTask, Runnable finishTask) {
