...
public class InertiaAntiCheatConstants {
    ...
    public static final Identifier PING_PACKET_ID = new Identifier("inertiaanticheat", "ping");
    public static final Identifier PONG_PACKET_ID = new Identifier("inertiaanticheat", "pong");
